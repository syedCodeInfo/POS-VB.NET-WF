...
Public Class SpeedPost
    ...
    Private Sub PostBtn_Click(sender As Object, e As EventArgs) Handles PostBtn.Click
        ...
        Dim sExtraAmount As String = sextra.Text
        ...
        totalAmount = Convert.ToInt32(sExtraAmount) + camount
        ...
        Dim cmd3 As SqlCommand = New SqlCommand("insert into Post(SenderAddressId,ReceiverAddressId,Acknowlegment,CommissionAmount,WeightAge,TotalAmount,ExtraAmount,CreatedAt,postType) values" & "('" & saddressID & "','" & raddressID & "','true','" & sCommissionAmount.ToString() & "','" & sWeightage & "','" & totalAmount.ToString() & "','" & sExtraAmount & "','" & dateTime.ToString() & "','speed')", con)
